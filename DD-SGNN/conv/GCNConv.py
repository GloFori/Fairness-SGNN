...
class GCNConv(MessagePassing):
    ...
    def forward(self, x: Tensor, edge_index: Adj, head,
                edge_weight: OptTensor = None) -> tuple[Union[Tensor, Any], Any]:
        ...
        neighbor = self.propagate(edge_index, x=x, edge_weight=None)
        m = self.r(x, neighbor)
        if head:
